...
export interface Profile {
  ...
  caretaker_property_id?: string | null;
  caretaker_approved?: boolean | null;
...
export interface Property {
  ...
  is_active: boolean;
  payment_model?: "pay_once" | "pay_per_inquiry";
  listing_model?: "flat_fee" | "pay_per_lead";
  lead_credits?: number;
  is_boosted?: boolean;
...
export interface Inquiry {
  ...
  unlocked_by_credit_tx_id?: string | null;
  tenant_name?: string;
  tenant_phone?: string;
  tenant_email?: string;
  reply?: string;
