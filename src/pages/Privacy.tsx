...
export const Privacy: React.FC = () => {
  useEffect(() => {
    ...
    canonical.setAttribute("href", "https://nestlist.co.ke/privacy");
  }, []);
          ...
          <main className="lg:col-span-8 max-w-[800px] mx-auto text-stone-700 leading-relaxed text-sm sm:text-[15px] space-y-12">
                ...
                <div className="bg-emerald-50 border-l-4 border-emerald-700 rounded-r-xl p-4 my-2 text-emerald-950">
                  <div className="flex gap-2">
                    ...
                    <p className="text-xs sm:text-sm font-medium">
                      <strong>Scam Warning:</strong> NestList will never, under any circumstances, call or email you to request your M-Pesa PIN. If someone claiming to represent NestList asks for your PIN, please hang up immediately and report them to us at <a href="mailto:info@nestlist.co.ke" className="underline font-bold">info@nestlist.co.ke</a>.
                    </p>
                  </div>
                </div>
            ...
            <section id="your-rights" className="scroll-mt-20">
              ...
              <div className="pl-5 border-l-4 border-emerald-700 space-y-4">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 text-stone-950">
                  ...
                  <p className="text-xs sm:text-sm text-stone-800 leading-relaxed">
                    Simply write to us at <a href="mailto:info@nestlist.co.ke" className="underline font-bold text-emerald-850">info@nestlist.co.ke</a> or reach out on our support phone: <a href="tel:+254715185037" className="underline font-bold text-emerald-850">+254715185037</a>. We will verify your identity first to protect your account and respond to your request within <strong>14 days</strong>.
                  </p>
                </div>
            ...
            <section id="childrens-privacy" className="scroll-mt-20">
              ...
              <div className="pl-5 border-l-4 border-emerald-700 space-y-3">
                ...
                <p>
                  If you discover that a child has created an unauthorized profile on our website, please notify us immediately at <a href="mailto:info@nestlist.co.ke" className="text-emerald-700 underline font-medium">info@nestlist.co.ke</a>. We will immediately delete their information from our systems.
                </p>
              </div>
            </section>
                ...
                <div className="bg-stone-50 rounded-2xl p-6 border border-stone-200 grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <p className="flex items-center gap-2 text-stone-600">
                      ...
                      <a href="mailto:info@nestlist.co.ke" className="hover:text-emerald-800 hover:underline">info@nestlist.co.ke</a>
                    </p>
                    <p className="flex items-center gap-2 text-stone-600">
