      ...
      <div style={cardStyle} className="animate-fade-in">
        ...
        <form onSubmit={handleSubmit} style={{ textAlign: "left" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            {/* Caretaker Post-signup Approval Note */}
            {role === "caretaker" && (
              <div style={{
                marginTop: "12px",
                padding: "10px 14px",
                ...
                <span style={{ fontWeight: "700" }}>🔑 Caretaker Notice:</span> Property access must be approved by the property owner/landlord after registration. You do not need to link a property during signup.
              </div>
            )}
          </div>

          {/* Agent Agency Name Field (Optional) */}
          {role === "agent" && (
            <div style={{ marginBottom: "16px", textAlign: "left" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                <label style={{ ...labelStyle, marginBottom: 0 }}>Agency / Company Name</label>
          ...
          <button type="submit" disabled={!isFormValid || loading} style={buttonStyle} className="hover:brightness-95 active:scale-95 duration-150">
            {loading ? "Creating..." : `Create ${role === "tenant" ? "Tenant" : role === "landlord" ? "Landlord" : role === "caretaker" ? "Caretaker" : "Agent"} account →`}
          </button>
        </form>
